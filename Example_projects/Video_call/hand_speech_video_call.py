...
model = joblib.load("video call/2_hand_model.pkl")
...
def play_sound():
    script_path = "video call/play_sound.py"
    subprocess.Popen(["python", script_path])

def speak(text):
    # print("Bot: {}".format(text))
    tts = gTTS(text=text, lang=language, slow=False)
    tts.save("video call/sound.mp3")
    # play_sound()
...
def start_detection():
    ...
    while running:
        ...
        if hands:
            ...
            font = ImageFont.truetype("2_hand/arial.ttf", 40)
